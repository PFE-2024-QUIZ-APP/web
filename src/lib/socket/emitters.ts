...
export const editRoomEmit = (data: EditRoomInput) => io.emit('editRoom', data.uidQuizz);
export const joinRoomEmit = (data: JoinRoomInput, cb: (data: JoinRoomCallBackInput) => any) => io.emit('join', data, cb);
